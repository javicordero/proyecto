     ...
     <div class="x_panel">
         <div class="x_title index-title">
             ...
             <div class="index-title-button">
                 <button class="btn btn-success " type="button" data-csrf="{{ csrf_token() }}" data-playerId="{{ $data['player']->id }}" type="button" id="attributes-modal">
                     Evaluar
                 </button>
             </div>
             @endif
             ...
             <ul class="list-unstyled user_data">
                 <li>
                     ...
                     <div class="progress progress_sm">
                         <div class="progress-bar" role="progressbar" id="progress-bar" data-transitiongoal="{{ $attribute->getPlayerCurrentValue($data['player']->id) * 5 }}" data-attributeId="{{ $attribute->id }}" data-playerId="{{ $data['player']->id }}" data-csrf="{{ csrf_token() }}">
                         </div>
                     </div>
                 </li>
             </ul>
