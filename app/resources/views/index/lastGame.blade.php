                    ...
                    <div class="sport-team-wrap ftco-animate">
                        ...
                        <div class="d-sm-flex mb-4">
                            <div class="sport-team d-flex align-items-center">
                                <div class="img logo"
                                    style="background-image: url({{ $data['lastGame']->home ? $data['lastGame']->team->logo_image_path : $data['lastGame']->opponent->image_path }});">
                                </div>
                            ...
                            <div class="sport-team d-flex align-items-center">
                                <div class="img logo order-sm-last"
                                    style="background-image: url({{ $data['lastGame']->home ? $data['lastGame']->opponent->image_path : $data['lastGame']->team->logo_image_path }});">
                                </div>
                                <div class="text-center px-1 px-md-3 desc">
                                    <h3 class="
                                    @if (!$data['lastGame']->home) {{ $data['lastGame']->victory ? 'score win' : 'score lost' }}
